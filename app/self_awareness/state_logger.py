"""
app.self_awareness.state_logger — shim module.

The implementation moved to app.subia.belief.state_logger as part of the unified
...
from app.subia.belief.state_logger directly. Shim retained for one release cycle.
"""
...
import app.subia.belief.state_logger as _target
