"""
app.self_awareness.sentience_config — shim module.

The implementation moved to app.subia.sentience_config as part of the unified
...
from app.subia.sentience_config directly. Shim retained for one release cycle.
"""
...
import app.subia.sentience_config as _target
