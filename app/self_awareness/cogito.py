"""
app.self_awareness.cogito — shim module.

The implementation moved to app.subia.belief.cogito as part of the unified
...
from app.subia.belief.cogito directly. Shim retained for one release cycle.
"""
