...
def _build_setter_registry():
    ...
    from app.runtime_settings import (
        ...
        set_sandboxed_gee_exec_enabled,
        set_sandboxed_tool_exec_enabled,
        set_research_experiment_repair_enabled,
        set_research_citation_verification_enabled,
        set_deep_research_auto_enabled,
        set_deep_research_min_score,
        set_deep_research_wall_clock_s,
        set_deep_research_fusion_enabled,
        set_deep_research_max_panel,
        set_research_compose_paper_enabled,
        set_tripit_ical_url,
    ...
    return {
        ...
        "sandboxed_gee_exec_enabled": (set_sandboxed_gee_exec_enabled, bool),
        "sandboxed_tool_exec_enabled": (set_sandboxed_tool_exec_enabled, bool),
        "research_experiment_repair_enabled": (set_research_experiment_repair_enabled, bool),
        "research_citation_verification_enabled": (set_research_citation_verification_enabled, bool),
        "deep_research_auto_enabled": (set_deep_research_auto_enabled, bool),
        "deep_research_min_score": (set_deep_research_min_score, int),
        "deep_research_wall_clock_s": (set_deep_research_wall_clock_s, int),
        "deep_research_fusion_enabled": (set_deep_research_fusion_enabled, bool),
        "deep_research_max_panel": (set_deep_research_max_panel, int),
        "research_compose_paper_enabled": (set_research_compose_paper_enabled, bool),
        # Q9.3 travel
