...
_JOBS = [
    ...
    # SelfImprovementCrew writes to ``workspace/proposals/<id>_<name>/``;
    # new subdir creation bumps the parent dir's mtime. The legacy path
    # ``workspace/self_improvement/`` is only touched by velocity_digest
    # (different cadence), which produced a 4-day false-positive stale
    # alert before this was fixed. 2026-05-22.
    ("self_improve", "workspace/proposals", 24 * 3600),
