"""
app.consciousness.prediction_hierarchy — shim module.

The implementation moved to app.subia.prediction.hierarchy as part of the unified
...
from app.subia.prediction.hierarchy directly. Shim retained for one release cycle.
"""
...
import app.subia.prediction.hierarchy as _target
