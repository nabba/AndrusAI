"""
firebase_infra.py — Shared Firestore infrastructure.

Core utilities used by all firebase_* modules:
...
def _get_db():
    ...
    with _db_lock:
        ...
        try:
            ...
            logger.info("firebase_infra: Firestore client initialised")
        except Exception:
            logger.warning("firebase_infra: Firestore unavailable — monitoring disabled", exc_info=True)
            _db = False
    return _db
